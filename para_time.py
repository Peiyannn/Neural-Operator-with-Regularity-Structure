...
x_test = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/x_test2_t.npy'))
x_train = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/x_train2_t.npy'))
# [sample, x, T, tree]
y_test = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/y_test2_t.npy'))
y_train = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/y_train2_t.npy'))
# [sample, X, T]

# x_test1 = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/x_test4_t1.npy'))
# x_train1 = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/x_train4_t1.npy'))
# # [sample, x, T, tree]
# y_test1 = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/y_test4_t1.npy'))
# y_train1 = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/y_train4_t1.npy'))
# # [sample, X, T]

# x_test2 = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/x_test4_t2.npy'))
# x_train2 = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/x_train4_t2.npy'))
# y_test2 = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/y_test4_t2.npy'))
# y_train2 = torch.from_numpy(np.load('/home/v-peiyanhu/rs+fno/parabolic_data/y_train4_t2.npy'))
