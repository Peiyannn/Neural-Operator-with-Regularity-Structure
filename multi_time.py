from NORS_1d_time import FNO_space1D_time, train_fno_1d
...
x_test = torch.from_numpy(np.load('/.../multi_data/x_test.npy'))
x_train = torch.from_numpy(np.load('/.../multi_data/x_train.npy'))
# [sample, x, T, tree]
u_test = torch.from_numpy(np.load('/.../multi_data/u_test.npy'))
u_train = torch.from_numpy(np.load('/.../multi_data/u_train.npy'))
# [sample, X, T]
