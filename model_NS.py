...
for i in range(int(N/k)):
    ...
    # # Then call
    Features_for_points = M.create_model_points_2d(forcing, lollipops = I_xi, diff = False, X = X, dt = sub_t*delta_t, batch_size = 10, extra_planted = I_c, extra_deg = 2, key = "I_c[u_0]",  points = points, diff=False)
    t3 = default_timer()
